...
extern void ReadFlexiaModels(TInputStream* pInput, vector<CFlexiaModel>& FlexiaModels );
extern void WriteFlexiaModels(FILE* out_fp, const vector<CFlexiaModel>& FlexiaModels );
extern void ReadAccentModels(TInputStream* pInput, vector<CAccentModel>&	AccentModels );
