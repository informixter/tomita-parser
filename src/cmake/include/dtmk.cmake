...
ELSE ()
    ...
    SET(CMAKE_C_FLAGS            "-pipe ${__debug_info_flag_} -Wall ${__pie_gcc_flag_} -W -Wno-parentheses -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -DGNU ${__use_c99_math_}")
...
DEFAULT(USE_INTERNAL_BISON no)

IF (USE_INTERNAL_BISON)
    SET_APPEND(CXXFLAGS -DUSE_INTERNAL_BISON)
ENDIF()
